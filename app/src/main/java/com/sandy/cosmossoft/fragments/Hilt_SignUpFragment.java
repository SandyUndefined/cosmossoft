...
abstract class Hilt_SignUpFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SignUpFragment_GeneratedInjector) generatedComponent()).injectSignUpFragment((SignUpFragment) UnsafeCasts.unsafeCast(this));
        }
    }
