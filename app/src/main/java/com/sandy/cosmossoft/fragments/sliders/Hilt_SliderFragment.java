...
abstract class Hilt_SliderFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_SliderFragment(int contentLayoutId) {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SliderFragment_GeneratedInjector) generatedComponent()).injectSliderFragment((SliderFragment) UnsafeCasts.unsafeCast(this));
        }
    }
