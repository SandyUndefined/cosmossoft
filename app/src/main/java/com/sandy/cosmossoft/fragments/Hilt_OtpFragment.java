...
abstract class Hilt_OtpFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_OtpFragment(int contentLayoutId) {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((OtpFragment_GeneratedInjector) generatedComponent()).injectOtpFragment((OtpFragment) UnsafeCasts.unsafeCast(this));
        }
    }
