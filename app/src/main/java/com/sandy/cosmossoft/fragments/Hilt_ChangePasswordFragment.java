...
abstract class Hilt_ChangePasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ChangePasswordFragment_GeneratedInjector) generatedComponent()).injectChangePasswordFragment((ChangePasswordFragment) UnsafeCasts.unsafeCast(this));
        }
    }
