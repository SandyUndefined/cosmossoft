...
abstract class Hilt_HomeMenuFragments extends Fragment implements GeneratedComponentManagerHolder {
    private ContextWrapper componentContext;
    private volatile FragmentComponentManager componentManager;
    private final Object componentManagerLock = new Object();
    private boolean injected = false;

    Hilt_HomeMenuFragments() {
    }

    Hilt_HomeMenuFragments(int contentLayoutId) {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((HomeMenuFragments_GeneratedInjector) generatedComponent()).injectHomeMenuFragments((HomeMenuFragments) UnsafeCasts.unsafeCast(this));
        }
    }
