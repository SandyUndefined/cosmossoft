...
abstract class Hilt_AnalyticFragment extends Fragment implements GeneratedComponentManagerHolder {
    private ContextWrapper componentContext;
    private volatile FragmentComponentManager componentManager;
    private final Object componentManagerLock = new Object();
    private boolean injected = false;

    Hilt_AnalyticFragment() {
    }

    Hilt_AnalyticFragment(int contentLayoutId) {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AnalyticFragment_GeneratedInjector) generatedComponent()).injectAnalyticFragment((AnalyticFragment) UnsafeCasts.unsafeCast(this));
        }
    }
