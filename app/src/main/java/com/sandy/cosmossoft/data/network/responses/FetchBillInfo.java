...
public class FetchBillInfo implements Serializable {
    ...
    public FetchBillInfo(Integer response_code2, boolean status2, String amount2, String name2, String duedate2, String billdate2, BillFetch bill_fetch2, String message2) {
