...
import com.sandy.cosmossoft.databinding.ActivityRechargeDetailedAnalyticBinding;
...
public class RechargeDetailedAnalytic extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActivityRechargeDetailedAnalyticBinding inflate = ActivityRechargeDetailedAnalyticBinding.inflate(getLayoutInflater());
        ...
        getSupportActionBar().setTitle((CharSequence) "Recharge Transaction");
    ...
    private void setJsonData() {
        try {
            if (this.historyResponse.getData_response() != null) {
                new JSONObject(this.historyResponse.getData_response());
                String sm = this.model.getStatus().toLowerCase();
                if (sm.equals(Constants.EVENT_LABEL_SUCCESS)) {
        ...
        this.shareResponse = this.model.getStatus();
    }
