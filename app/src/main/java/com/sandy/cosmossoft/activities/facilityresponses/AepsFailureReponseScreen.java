...
import com.sandy.cosmossoft.databinding.ActivityAepsFailureReponseScreenBinding;
...
public class AepsFailureReponseScreen extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActivityAepsFailureReponseScreenBinding inflate = ActivityAepsFailureReponseScreenBinding.inflate(getLayoutInflater());
        ...
        getSupportActionBar().setTitle((CharSequence) "Failed");
