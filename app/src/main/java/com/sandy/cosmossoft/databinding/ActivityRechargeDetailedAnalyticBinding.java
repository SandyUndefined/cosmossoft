...
public abstract class ActivityRechargeDetailedAnalyticBinding extends ViewDataBinding {
    ...
    public static ActivityRechargeDetailedAnalyticBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActivityRechargeDetailedAnalyticBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ActivityRechargeDetailedAnalyticBinding) ViewDataBinding.inflateInternal(inflater, C0330R.layout.activity_recharge_detailed_analytic, root, attachToRoot, component);
    }

    public static ActivityRechargeDetailedAnalyticBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActivityRechargeDetailedAnalyticBinding inflate(LayoutInflater inflater, Object component) {
        return (ActivityRechargeDetailedAnalyticBinding) ViewDataBinding.inflateInternal(inflater, C0330R.layout.activity_recharge_detailed_analytic, (ViewGroup) null, false, component);
    }

    public static ActivityRechargeDetailedAnalyticBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActivityRechargeDetailedAnalyticBinding bind(View view, Object component) {
        return (ActivityRechargeDetailedAnalyticBinding) bind(component, view, C0330R.layout.activity_recharge_detailed_analytic);
    }
}
