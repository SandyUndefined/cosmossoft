...
public class ActivityPayWithPayTmBindingImpl extends ActivityPayWithPayTmBinding {
    ...
    public ActivityPayWithPayTmBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }

    private ActivityPayWithPayTmBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
